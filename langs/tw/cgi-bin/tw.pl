...
'frequency' => '頻率',
'friday' => '星期五',
'fritzdsl help' => '要使用Fritz！DSL fcdsl / fcdslsl / fcdsl2 / fcdslusb / fcdslslusb調製解調器之一，必須將軟體包上傳到IPFire。 請從IPFire網站下載與您的版本相對應的tarball，然後使用下面的表格上傳整個<b> fcdsl-（your_version）.tgz</b>',
...
'net config type help' => '綠色是局域網，紅色是網際網路，藍色是WLAN，橙色是DMZ。',
...
'ipblocklist category c and c' => '惡意軟體 C&amp;C',
