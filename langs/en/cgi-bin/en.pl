...
'ipblocklist use xdp' => 'XDP Acceleration (Driver-level blocking)',
'ipblocklist xdp active' => 'XDP Acceleration Active:',
'ipblocklist xdp blocking' => 'Blocking is performed at network driver level using XDP. No firewall reload needed when changing blocklists.',
'ipblocklist iptables active' => 'Traditional iptables Active:',
...
'sunday' => 'Sunday',
'support donation' => 'Support the LoongFire project with your donation',
'swap' => 'Swap',
...
'xdp tcp ddos config' => 'XDP TCP DDoS Configuration',
'xdp tcp ddos' => 'XDP TCP DDoS',
'xdp tcp ddos enable' => 'Enable XDP TCP DDoS Protection',
'xdp tcp port' => 'TCP Port',
