...
'dnsbl acl' => '访问控制',
'dnsbl acl explanation' => '默认情况下，拦截将应用于整个网络。您可以配置仅对该类别适用的若干网络区域、主机或子网',
'dnsbl custom block and allow list' => '自定义拦截与放行列表',
'dnsbl custom source' => '自定义来源',
...
'ids enable email alerts' => '启用邮件警报',
...
'ids high, medium and low severity' => '高、中、低严重级别',
'ids ignored hosts' => '列入白名单的主机',
'ids invalid mail address' => '是或包含无效的邮件地址',
...
'ids no email recipients' => '未提供邮件收件人',
'ids no email sender' => '未指定发件人邮箱地址',
...
'lldp' => '链路层发现协议',
'lldp neighbors' => '邻居',
'lldp there are no neighbors' => '当前无邻居',
'load printer' => '加载打印机',
...
'transfers' => 'Transfers',
'transient sheduler attacks' => '瞬态调度器攻击',
...
'xdpsni log' => 'XDP记录的加密网站访问日志',
'xdpsni hits' => '加密网站访问日志总数',
'xdp tcp ddos config' => 'XDP TCP 防分布式攻击配置',
'xdp tcp ddos' => 'XDP TCP 防分布式攻击',
'xdp tcp ddos enable' => '启动XDP TCP 防分布式攻击 ',
'xdp tcp port' => 'TCP 端口',
